...
public class prmDB {
	...
	public prmDB(String grievanceId, Date date, String fullName, String mobile, String tehsil, String village,
			String address, long aadharNo, String grievance, String status, String forwardedToDept) {
		super();
	...
	public String toString() {
		return "prmDB [grievanceId=" + grievanceId + ", date=" + date + ", fullName=" + fullName + ", mobile=" + mobile
				+ ", tehsil=" + tehsil + ", village=" + village + ", address=" + address + ", aadharNo=" + aadharNo
				+ ", grievance=" + grievance + ", status=" + status + ", forwardedToDept=" + forwardedToDept + "]";
	}
