...
public class hodDB {
	...
	public hodDB(String grievanceId, Date date, String fullName, String mobile, String tehsil, String village,
			String address, int aadharNo, String grievance, String status, String forwardedToDept) {
		super();
	...
	public String toString() {
		return "hodDB [grievanceId=" + grievanceId + ", date=" + date + ", fullName=" + fullName + ", mobile=" + mobile
